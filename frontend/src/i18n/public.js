...
const base = {
  common: {
    ...
    eyebrow: "Digital public grievance redressal",
    language: "Language",
    portalSubtitle: "AI-assisted grievance redressal portal",
    livePlatform: "Jan Samadhan AI public portal",
    backToPortal: "Back to portal",
    openLogin: "Open login",
  },
  portal: {
    subtitle: "AI-assisted grievance redressal portal",
    ...
    heroDescription: "Jan Samadhan AI helps citizens register, submit grievances, receive a ticket ID, track status in real time, and share feedback after resolution.",
    trustSignals: [
    ...
    heroText: "A direct entry for citizens to register, sign in, file complaints, and track tickets.",
    cardTitle: "Public services",
    cardText: "Citizens use this area for registration, login, and ticket tracking. Officer and admin tools stay protected after sign-in.",
    login: "Sign In",
    ...
    footer: "Citizen entry is public. Officer and admin workflows stay protected after sign-in.",
    accessTag: "Public service access",
    guideBadge: "Citizen guide",
    guideTitle: "How citizens use Jan Samadhan AI",
    guideText: "Follow this simple path from account creation to complaint tracking and final feedback.",
    guideSteps: [
      {
        title: "Create a verified account",
        text: "Register with your name, email OTP, state, district, locality, and pincode so updates stay linked to you.",
      },
      {
        title: "File a clear complaint",
        text: "Add the issue title, description, and location. Clear details help AI route the case to the right department.",
      },
      {
        title: "Add location or proof",
        text: "Add GPS coordinates, area details, or an attachment when it helps officers verify the issue faster.",
      },
      {
        title: "Submit and note the ticket ID",
        text: "Every submitted complaint gets a ticket ID. Keep it safe for public tracking.",
      },
      {
        title: "Track progress anytime",
        text: "Use the tracking page to see status, department, assigned officer, and timeline updates.",
      },
    ],
    ...
    aboutText: "Jan Samadhan AI helps citizens file complaints clearly, routes cases to the right department and officer, and keeps tracking visible until closure.",
    aboutCards: [
      {
        title: "Simple public entry",
        text: "Citizens can register, sign in, file complaints, and track tickets without entering internal admin screens.",
      },
      {
        title: "Smart complaint routing",
        text: "AI classification and department mapping help send each complaint to the right handling team.",
      },
      {
    ...
    contactText: "First-time users should register before filing. If you already have a ticket ID, open tracking to view progress.",
    ...
    siteMapFlowText: "This flow shows the complaint journey in Jan Samadhan AI, from citizen filing to department routing, officer action, and final tracking.",
    siteMapFlowSteps: [
      ...
      { title: "AI and department mapping happen", text: "The system classifies the complaint and connects it to the right department." },
    ...
    siteMapCitizenGuides: [
      ...
      },
      {
        ...
        text: "Use this path when you already have a ticket ID and want the latest status.",
  ...
  login: {
    ...
    description: "Secure sign-in for citizens, officers, and administrators working on grievance resolution.",
    badges: ["Admin", "Officer", "Citizen tracking"],
    asideTitle: "After sign-in",
    asideText: "Users enter the right workspace for complaint filing, officer action, department management, and reporting.",
    username: "Email / Username",
    password: "Password",
    enterUsername: "Citizen users: enter your registered email address",
    ...
    points: [
      {
        ...
        text: "Track each complaint from citizen intake to department action and closure.",
      },
      {
        title: "Officer controls",
        text: "Officers can update status, upload proof, forward, escalate, and close assigned work.",
      },
      {
        title: "Multi-department ready",
        text: "Admins can create departments, add officers, and map complaints to the right teams.",
      },
    ],
  },
  register: {
    subtitle: "Citizen registration",
    description: "Create a verified citizen account for filing complaints, tracking progress, and giving closure feedback.",
    badges: ["Email OTP", "Location details", "Ticket tracking"],
    asideTitle: "Citizen onboarding",
    asideText: "Registration captures only the identity and location details needed to file and track complaints.",
    ...
    points: [
      {
        ...
        text: "OTP verification confirms the citizen email before the account is activated.",
      },
      {
        title: "Useful location details",
        text: "State, district, locality, and pincode help route complaints to the correct department area.",
      },
      {
        title: "Ready to file complaints",
        text: "After verification, citizens can enter the dashboard and submit trackable complaints.",
      },
    ],
  },
  track: {
    ...
    asideTitle: "Ticket transparency",
    asideText: "One ticket ID shows complaint status, department, assigned officer, supervising head, and timeline updates.",
    ...
    points: [
      ...
      },
      {
        ...
        text: "The assigned officer and supervising head remain visible throughout the complaint journey.",
      },
    ],
  },
  dashboard: {
    ...
    badges: ["24x7 grievance lodging", "Unique registration ID tracking", "AI assisted routing"],
    lodgeGrievanceBtn: "Lodge Grievance",
    editProfileBtn: "Edit Profile",
    profileBtn: "Profile",
    tabComplaints: "Complaints",
    tabProfile: "Profile",
    cardLodgeTitle: "Lodge Public Grievance",
    cardLodgeText: "Submit issue details with AI routing, GPS, voice input, and supporting media.",
    cardLodgeCTA: "Lodge grievance",
    cardViewTitle: "View Status",
    cardViewCTA: "Open register",
    cardReminderTitle: "Send Reminder",
    cardReminderCTA: "Send reminder",
    cardFeedbackTitle: "Feedback / Appeal",
    cardFeedbackCTA: "Rate handler",
    statTotalLabel: "Total Registered",
    statTotalSub: "All grievances filed",
    statPendingLabel: "Pending Action",
    statPendingSub: "Under review or assigned",
    statDisposedLabel: "Disposed",
    statDisposedSub: "Resolved, closed, or rejected",
    statEscalatedLabel: "Escalated",
    statEscalatedSub: "Needs higher attention",
    formTitle: "Register a new citizen complaint",
    formSubtitle: "Lodge Public Grievance",
    formAlert: "Write one clear issue per registration. Location, documents, media proof, and voice input help officers verify and resolve faster.",
    formTitleLabel: "Title",
    formTitlePlaceholder: "Short issue title",
    formDescriptionLabel: "Description",
    formDescriptionSubtext: "(Hindi or English both accepted)",
    formVoiceLanguageLabel: "Voice input language",
    formVoiceButtonLabel: "Voice / Record",
    formStopVoiceButton: "Stop voice",
    formStopRecordingButton: "Stop recording",
    formVideoButtonLabel: "Video / Record",
    formStopVideoButton: "Stop video",
    formLocationLabel: "Location / Address",
    formLocationSubtext: "Use GPS to fill address boxes automatically",
    formLocationPlaceholder: "Street, ward, landmark, or area",
    formGPSButton: "GPS Fill",
    formGPSDetecting: "Detecting...",
    formAddressDetailsLabel: "Address details",
    formAddressDetailsSub: "Coordinates are kept for officer map routing and nearby assignment.",
    formMapCoordinatesBtn: "Map coordinates",
    formHideCoordinatesBtn: "Hide coordinates",
    formAttachmentLabel: "Attachment proof (optional)",
    formCameraRecording: "Camera recording in progress",
    formAttachmentPlaceholder: "Upload photo, PDF, audio, or video",
    formAttachmentDesc: "Camera photos, documents, recordings, and videos are accepted",
    formSubmitBtn: "Submit Complaint",
    formSubmittingBtn: "Submitting...",
    formRegistrationIdLabel: "Registration ID",
    formCopyIdBtn: "Copy ID",
    formShareBtn: "Share",
    formContinueBtn: "File Another",
    formAIClassification: "AI classification",
    formLocationRouting: "Location routing",
    formMediaProof: "Photo, PDF, audio, video",
    registerIdLatestPrefix: "Latest registration ID:",
    noLatestComplaint: "Track all registration IDs from one case register.",
    voiceRecordingInProgress: "Recording audio proof now. Press Stop recording when complete; it will be attached below.",
...
const overrides = {
  ...
  // Additional fallback translations for remaining 11 languages
  bodo: {},
  doi: {},
  ks: {},
  gom: {},
