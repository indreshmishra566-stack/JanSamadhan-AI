...
const base = {
  ...
  portal: {
    ...
    siteMapPagesTitle: "Public navigation pages",
    siteMapPagesText: "These pages explain the service clearly, just like a real government grievance portal, while keeping the main homepage focused and simple.",
...
const overrides = {
  hi: {
    ...
    portal: {
      ...
      siteMapPagesTitle: "सार्वजनिक नेविगेशन पेज",
      siteMapPagesText: "ये पेज एक वास्तविक सरकारी शिकायत पोर्टल की तरह सेवा को स्पष्ट करते हैं, जबकि मुख्य होमपेज को सरल और केंद्रित रखते हैं।",
